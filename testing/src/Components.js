/* Class contains all the styling aspects for the account page*/

import styled from 'styled-components';

/* Container for user to choose whether to sign in or sign up */ 
...
/* Overlay container which is what allows the one side (sign up or sign in option) to slide
once user presses button */
